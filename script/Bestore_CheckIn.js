 ...
 *
 * BoxJS 订阅: https://raw.githubusercontent.com/littleanzi/quantumultX/main/script/quan.boxjs.json
 *
 * 首次使用：
 * 1. 启用 rewrite 规则
...
function request(opts) {
  return new Promise(function (resolve, reject) {
    ...
    console.log('[Bestore] REQ: ' + opts.url)
...
async function main() {
  try {
    ...
    console.log('[Bestore] 错误: ' + (e.message || e))
    notify('良品铺子签到', '脚本错误', String(e.message || e))
    done()
  }
}
